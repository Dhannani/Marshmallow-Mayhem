...
public class PowerUp
{
	...
	///////////////////////////
	private static final Image REDPOWERUP = new Image("resources/redPowerup.png");
	private static final Image BLUEPOWERUP = new Image("resources/bluePowerup.png");
	private static final Image GREENPOWERUP = new Image("resources/greenPowerup.png");
	///////////////////////////
	...
	public PowerUp( Group g, double x, double y, int type )
	{
		...
		if( type == 1 )
		{
			...
			component.setFill(new ImagePattern(GREENPOWERUP));
			setType(1);
		}
		else if( type == 2 )
		{
			//component.setFill( Color.DARKBLUE );
			component.setFill(new ImagePattern(BLUEPOWERUP));
			setType(2);
		}
		else if( type == 3 )
		{
			//component.setFill( Color.CRIMSON );
			component.setFill(new ImagePattern(REDPOWERUP));
			setType(3);
		}
